  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        "src/hooks/useVotingState.ts": { lines: 100, functions: 100, branches: 100, statements: 100 },
        "src/hooks/useMotionSubmission.ts": { lines: 100, functions: 100, branches: 100, statements: 100 },
