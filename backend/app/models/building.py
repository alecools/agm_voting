...
class Building(Base):
    ...
    unarchive_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default="0")
    ...
    # Relationships
    lot_owners: Mapped[list["Lot"]] = relationship(  # noqa: F821
        "Lot", back_populates="building", cascade="all, delete-orphan"
    )
