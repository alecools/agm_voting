...
# ---------------------------------------------------------------------------
# Admin auth — legacy tests removed.
# Auth is now handled by Better Auth (Neon Auth).
# Tests for require_admin, get_client_ip, and AdminLoginRateLimitMiddleware
# live in tests/test_admin_auth_api.py.
# ---------------------------------------------------------------------------
